...
import {Avatar, Button, List, Modal, Popconfirm, Space, Typography,} from 'antd';
	...
	return (
		<ProCard direction="column" ghost gutter={[16, 8]}>
			<ProCard bordered bodyStyle={{padding: 0, margin: 0}}>
				<ProCard><Title level={3} style={{marginBottom: 0, paddingBottom: 0}}>Projects</Title></ProCard>
