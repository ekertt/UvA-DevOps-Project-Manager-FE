    ...
    >
      ...
      >
        <ProCard direction="row" bordered colSpan={8}>
          <ProCard ghost layout="center" colSpan={8} style={{ height: '100%' }}>
            <LandingPageSVG />
          </ProCard>
          ...
          <ProCard>
            ...
            <p style={{ marginBottom: 20, paddingTop: 15 }}>
              ...
              track progress, and categorize work items with just a few clicks.
              Our powerful AI technology takes care of categorization, leaving
              you more time to focus on what really matters - delivering your
